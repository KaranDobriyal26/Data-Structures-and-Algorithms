...
// For the given input, the even digits are 2, 2 and 4 and if we take the 
// sum of these digits it will come out to be 8(2 + 2 + 4) and similarly, if
// we look at the odd digits, they are, 5, 5 and 5 which makes a sum of 15(5 + 5 + 5). 
